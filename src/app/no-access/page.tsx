  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xl">
        <div className="backdrop-blur-xl bg-white/10 dark:bg-black/20 border border-white/20 rounded-3xl p-10 shadow-2xl">
          {/* Icon with Glow */}
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-red-500/30 blur-2xl rounded-full animate-pulse" />
              <div className="relative p-6 bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-2xl backdrop-blur-sm border border-red-500/30">
                <ShieldX className="h-16 w-16 text-red-400" strokeWidth={1.5} />
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center mb-6">
            <Badge className="px-4 py-2 bg-red-500/20 text-red-300 border border-red-500/30 backdrop-blur-sm">
          ...
          <div className="space-y-3">
            ...
            >
              <Button
                size="lg"
                className="w-full gap-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white border-0 shadow-lg shadow-green-500/20 group"
              >
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="w-full gap-3 bg-white/5 border-white/20 text-white hover:bg-white/10 backdrop-blur-sm group"
              >
            ...
            <Button
              ...
              className="w-full gap-3 text-slate-400 hover:text-white hover:bg-white/5 group"
            >
...
function InfoCard({
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-3 text-center hover:bg-white/10 transition-all">
